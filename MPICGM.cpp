...
int main(int argc, char **argv) {
    ...
    //Подготовка: Дробление исходной сетки, отправка подсетей на узлы
    ...
    //Определение числа строк и столбцов на каждом процессоре
    int procRows =  1 << procCR.first; //2^(procCR.first)
